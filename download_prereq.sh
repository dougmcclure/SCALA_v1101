...
#v1.2 7/14/13 Update for latest releases of WebSphere Liberty
#
#######################################################################################################
...
# about 52MB download
wget -O $PREREQ_DIR/box2/wlp-developers-runtime-8.5.5.0.jar https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/wasdev/downloads/wlp/8.5.5.0/wlp-developers-runtime-8.5.5.0.jar
...
#about 24MB download
wget -O $PREREQ_DIR/box2/wlp-developers-extended-8.5.5.0.jar https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/wasdev/downloads/wlp/8.5.5.0/wlp-developers-extended-8.5.5.0.jar
